    ...
    <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div class="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:grid-rows-2 sm:gap-x-6 lg:gap-8 ">
        <div class="group aspect-h-1 aspect-w-2 overflow-hidden rounded-lg sm:aspect-h-1 sm:aspect-w-1 sm:row-span-2">
          <img src="https://lunadogcoderstore.s3.ap-southeast-2.amazonaws.com/images/adventure/buttonsCottage02.jpeg" alt="" class="object-cover object-center group-hover:opacity-75">
        ...
        <div class="group aspect-h-1 aspect-w-2 overflow-hidden rounded-lg sm:aspect-none sm:relative sm:h-full">
          <img src="https://lunadogcoderstore.s3.ap-southeast-2.amazonaws.com/images/adventure/bamboo02.jpeg" alt=""
        ...
        <div class="group aspect-h-1 aspect-w-2 overflow-hidden rounded-lg sm:aspect-none sm:relative sm:h-full">
          <img src="https://lunadogcoderstore.s3.ap-southeast-2.amazonaws.com/images/adventure/c01.jpg" alt="" class="object-cover object-center group-hover:opacity-75 sm:absolute sm:inset-0 sm:h-full sm:w-full">
