<template>
  <div class="bg-white dark:bg-black">
    <div class=" mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
      ...
      <div class="mx-auto grid max-w-7xl grid-cols-1 gap-x-8 gap-y-12 mt-2 px-6 sm:gap-y-16 lg:grid-cols-2 lg:px-8">
          <article class="mx-auto w-full max-w-2xl lg:mx-0 lg:max-w-lg ">
            ...
            <p v-for="(line, index) in descriptionLines" :key="index" class="m-2  text-gray-600">{{line}}</p>
            ...
            <div class="-my-12 divide-y divide-gray-900/10">
              <article v-for="post in posts" :key="post.id" class="py-12">
                <div class=" group relative max-w-xl">
                  ...
                  <p class="mt-4 text-sm/8 text-gray-600 "> {{ post.description }}</p>
                </div>
