            ...
            <div class="flex flex-col lg:flex-row md:gap-10">
                <div class="lg:basis-1/2">
                    <div class="flex items-center">
                        <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Foxhound breed</h2> <Switch class="ms-8" :switchObj="Switch1" @toggle="toggleContent('Switch1')"></Switch>
                    </div>
                    ...
                    <div v-else>
                        <p class="mt-6 text-base leading-7 text-gray-600">猎狐犬是为了追捕狐狸而繁育的，数百年来一直被用于成群结队狩猎。在澳大利亚，猎狐犬可能是在19世纪由富有的英国移民带来的被囚禁的狐狸的伴侣，以便他们可以在这里骑马狩猎，怀念“家乡”的生活方式。狩猎队在澳大利亚的大多数州仍在运营，除了西澳大利亚和北领地。</p>
                        <p class="mt-6 text-base leading-7 text-gray-600">猎狐犬是比格犬的高个子版本，毛发光滑，下垂的耳朵，具有敏锐的嗅觉，追捕速度更快。它是一种高大而英俊的猎犬，前腿长而非常直。头部长，略呈圆顶形，头骨大。耳朵宽而下垂，勾勒出脸部的轮廓。眼睛大而宽间距，可以是棕色或褐色，带着甜美而乞求的表情。耳朵宽阔，贴平在头部上。尾巴位置适中，略微上翘，但不会向前翻卷在背上。</p>
                    </div>
