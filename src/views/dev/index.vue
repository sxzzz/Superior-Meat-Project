<template>
  <div class="relative">
      ...
      <div class="fixed right-0 bottom-1/4 z-40 hidden md:block">
        <button
            @click="togglePanel"
      ...
      <div :class="{ 'blur-sm': showPanel }" class="transition duration-600">
        <div class="bg-white dark:bg-black">
          <div class=" mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
            <h2 class="text-2xl font-bold tracking-tight bg-gradient-to-r from-indigo-600 via-purple-500 to-pink-500 inline-block text-transparent bg-clip-text mb-4">Music player</h2>
            <!-- music player-->
            <div>
          ...
          <!--  tasklist-->
          <div class="bg-teal-300 dark:bg-teal-700">
            <div class="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
              <h2 class="text-2xl font-bold tracking-tight bg-gradient-to-r from-indigo-600 via-purple-500 to-pink-500 inline-block text-transparent bg-clip-text mb-4">Dev plan</h2>
