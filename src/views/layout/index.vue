  ...
  <div class=" dark:bg-black">
    ...
    <section class="flex flex-col md:my-14 w-full mx-auto max-w-7xl px-5">
      <p
          ...
          class="text-primary">cupcakeipsum</span></p>
      <p class="text-center font-normal text-lg mt-5 self-center max-w-[900px] text-gray-700 dark:text-white">Cupcake ipsum dolor sit amet jelly beans sweet. Sugar plum liquorice toffee powder sesame snaps.
        Tiramisu toffee danish marshmallow gingerbread dessert sweet roll carrot cake.</p>
      <div
        ...
        <div class="flex flex-col justify-center items-center">
          ...
          <p class="font-medium text-lg mt-4 text-center dark:text-white">Monthly start $35</p></div>
        <div class="flex flex-col justify-center items-center">
          <div class="h-24 w-24 text-orange-500">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
          ...
          <p class="font-medium text-lg mt-4 text-center dark:text-white">Verified Experts</p></div>
        <div class="flex flex-col justify-center items-center">
          <div class="h-24 w-24 text-orange-500">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
          ...
          <p class="font-medium text-lg mt-4 text-center dark:text-white">Instant Availability</p></div>
        <div class="flex flex-col justify-center items-center">
          <div class="h-24 w-24 text-orange-500">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
          ...
          <p class="font-medium text-lg mt-4 text-center dark:text-white">Identification</p></div>
        <div class="flex flex-col justify-center items-center">
          <div class="h-24 w-24 text-orange-500">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
          ...
          <p class="font-medium text-lg mt-4 text-center dark:text-white">Multiple Languages</p></div>
      </div>
    </section>
    <section class="my-20 z-10">
      <div class="flex flex-col items-center ">
        <p class="text-2xl md:text-4xl text-[#171717] text-center mb-5 font-bold dark:text-white">Cupcake
          <span class="text-primary ">ipsum</span>
        </p>
        <p class="text-base text-[#515151] text-center mb-10 mx-auto max-w-[650px] dark:text-white">Cupcake ipsum dolor sit amet brownie pastry pie. Apple pie wafer jujubes jelly cupcake carrot cake wafer. Jelly-o chocolate cake cookie dragée cupcake brownie. Cupcake chocolate pastry marzipan gummi bears.
        </p>
      </div>
