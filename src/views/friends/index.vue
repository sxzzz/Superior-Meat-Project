  ...
  <div class="bg-white py-24 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl sm:text-center">
        <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Luna's Friends</h2>
        <p class="mt-6 text-lg leading-8 text-gray-600">We’re all lubabababbababa.</p>
      </div>
      <ul role="list" class="mx-auto mt-20 grid max-w-2xl grid-cols-1 gap-x-6 gap-y-20 sm:grid-cols-2 lg:max-w-4xl lg:gap-x-8 xl:max-w-none">
        <li class="flex flex-col gap-6 xl:flex-row">
          ...
          <div class="flex-auto">
            <h3 class="text-lg font-semibold leading-8 tracking-tight text-gray-900">Cookies</h3>
            <p class="text-base leading-7 text-gray-600">我的品种</p>
            <p class="mt-6 text-base leading-7 text-gray-600">自我介绍</p>
          </div>
        </li>
        <li class="flex flex-col gap-6 xl:flex-row">
          ...
          <div class="flex-auto">
            <h3 class="text-lg font-semibold leading-8 tracking-tight text-gray-900">Bamboo</h3>
            <p class="text-base leading-7 text-gray-600">我的品种 </p>
            <p class="mt-6 text-base leading-7 text-gray-600">bamboo的自我介绍</p>
          </div>
        </li>
        <li class="flex flex-col gap-6 xl:flex-row">
          <img class="aspect-[4/5] w-52 flex-none rounded-2xl object-cover" src="https://images.unsplash.com/photo-1519345182560-3f2917c472ef?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=8&w=1024&h=1024&q=80" alt="">
