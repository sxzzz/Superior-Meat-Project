        ...
        <div class="sm:px-6 lg:max-w-7xl lg:px-8">
          <section aria-labelledby="details-heading">
            <div class="flex flex-col items-center text-center">
              <h2 id="details-heading" class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl dark:text-gray-300">Beagle</h2>
              <p class="mt-3 max-w-3xl text-lg text-gray-600 dark:text-gray-300">Beagles, with their small and sturdy build, are delightful companions for both children and adults. These canine darlings possess an abundance of energy and a playful nature. However, being hounds, they can exhibit a stubborn streak, necessitating patient and innovative training methods. </p>
            </div>
