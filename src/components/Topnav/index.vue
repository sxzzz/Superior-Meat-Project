      ...
      <div class="relative flex h-16 justify-between">
        ...
        <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
          ...
          <div class="dark:bg-black hidden sm:ml-4 sm:flex sm:space-x-6">
              <router-link to="/hero"
                           :class="['inline-flex items-center border-b-2', $route.path === '/hero' ? 'border-indigo-500' : 'border-transparent', 'px-1 pt-1 text-sm font-medium text-gray-500 dark:text-gray-400 hover:border-gray-300 hover:text-gray-700 dark:hover:text-pink-200']">
            ...
            <router-link to="/artGallery"
                         :class="['inline-flex items-center border-b-2', $route.path === '/artGallery' ? 'border-indigo-500' : 'border-transparent', 'px-1 pt-1 text-sm font-medium text-gray-500 dark:text-gray-400 hover:border-gray-300 hover:text-gray-700 dark:hover:text-pink-200']">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 me-2">
            ...
            <router-link to="/adventure"
                         :class="['inline-flex items-center border-b-2', $route.path === '/adventure' ? 'border-indigo-500' : 'border-transparent', 'px-1 pt-1 text-sm font-medium text-gray-500 dark:text-gray-400 hover:border-gray-300 hover:text-gray-700 dark:hover:text-pink-200']">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 me-2">
            ...
            <router-link to="/friends"
                         :class="['inline-flex items-center border-b-2', $route.path === '/friends' ? 'border-indigo-500' : 'border-transparent', 'px-1 pt-1 text-sm font-medium text-gray-500 dark:text-gray-400 hover:border-gray-300 hover:text-gray-700 dark:hover:text-pink-200']">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 me-2">
            ...
            <router-link to="/breed"
                         :class="['inline-flex items-center border-b-2', $route.path === '/breed' ? 'border-indigo-500' : 'border-transparent', 'px-1 pt-1 text-sm font-medium text-gray-500 dark:text-gray-400 hover:border-gray-300 hover:text-gray-700 dark:hover:text-pink-200']">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 me-2">
